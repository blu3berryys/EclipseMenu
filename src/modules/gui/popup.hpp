...
class Popup {
 public:
  ...
  static void create(const std::string &title, const std::string &message,
                     const std::string &button1, const PopupCallback &callback);
  static void create(const std::string &title, const std::string &message);

  static void prompt(const std::string &title, const std::string &message,
                     const PromptCallback &callback,
                     const std::string &defaultValue = "");
  static void prompt(const std::string &title, const std::string &message,
                     const PromptCallback &callback, const std::string &button1,
  ...
  [[nodiscard]] const PromptCallback &getPromptCallback() const {
