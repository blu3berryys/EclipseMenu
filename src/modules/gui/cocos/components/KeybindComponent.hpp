...
class KeybindComponentNode
 ...
 public:
  bool init(float width) override {
    ...
    auto btnSprite = cocos2d::extension::CCScale9Sprite::create(
    ...
    auto btn =
        geode::cocos::CCMenuItemExt::createSpriteExtra(btnSprite, [this](auto) {
          SelectKeybindPopup::create(
              config::get<keybinds::Keys>(m_component->getId(),
                                          keybinds::Keys::None),
              [ref = geode::Ref(this)](auto key) {
                ...
                key = config::get<keybinds::Keys>(component->getId(),
                                                  keybinds::Keys::None);
