...
Color::operator cocos2d::ccColor4F() const { return {r, g, b, a}; }
...
Color::HSL Color::toHSL() const { return HSL::fromColor(*this); }

Color Color::fromHSL(const HSL &hsl) const { return HSL::toColor(hsl); }
