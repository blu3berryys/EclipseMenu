...
class ToggleComponent : public Component {
 public:
  ...
  /// @brief Set a callback function to be called when the component value
  /// changes.
...
class MenuTab {
 public:
  ...
  std::shared_ptr<ToggleComponent> addToggle(const std::string &title,
                                             const std::string &id) {
  ...
  std::shared_ptr<ComboComponent> addCombo(const std::string &title,
                                           const std::string &id,
  ...
  std::shared_ptr<InputIntComponent> addInputInt(const std::string &title,
                                                 const std::string &id,
                                                 int min = INT_MIN,
                                                 int max = INT_MAX) {
  ...
  std::shared_ptr<IntToggleComponent> addIntToggle(const std::string &title,
                                                   const std::string &id,
                                                   int min = INT_MIN,
                                                   int max = INT_MAX) {
  ...
  std::shared_ptr<InputTextComponent> addInputText(const std::string &title,
                                                   const std::string &id) {
  ...
  std::shared_ptr<ColorComponent> addColorComponent(const std::string &title,
                                                    const std::string &id,
                                                    bool hasOpacity = false) {
  ...
  std::shared_ptr<KeybindComponent> addKeybind(const std::string &title,
                                               const std::string &id,
                                               bool canDelete = false) {
...
enum class RendererType { None = -1, ImGui, Cocos2d };
...
class Renderer {
 public:
  ...
  /// @brief [Implementation specific] Calls the function after the main render
  /// loop
