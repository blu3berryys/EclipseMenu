...
public:
  ...
  static std::shared_ptr<MoveAction>
  create(double duration, ImVec2 *vector, ImVec2 target, EasingFunction easing);
  ...
  /// @return Progress in range [0, 1] (note that it can be out of this range if
  /// the animation is overshooting)
