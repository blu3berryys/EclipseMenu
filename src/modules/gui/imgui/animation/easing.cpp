...
double easeInSine(double t) { return 1.0 - cos(t * std::numbers::pi / 2.0); }

double easeOutSine(double t) { return sin(t * std::numbers::pi / 2.0); }
...
double easeOutCubic(double t) { return 1.0 - pow(1.0 - t, 3); }
...
double easeOutQuart(double t) { return 1.0 - pow(1.0 - t, 4); }
...
double easeOutQuint(double t) { return 1.0 - pow(1.0 - t, 5); }

double easeInOutQuint(double t) {
  return t < 0.5 ? (16.0 * t * t * t * t * t)
                 : (1.0 - pow(-2.0 * t + 2.0, 5) / 2.0);
}

/* == Exponential == */

double easeInExpo(double t) { return t == 0.0 ? t : pow(2.0, 10.0 * t - 10.0); }
...
double easeInCirc(double t) { return 1.0 - sqrt(1.0 - t * t); }
...
double easeInBack(double t) { return 2.70158 * t * t * t - 1.70158 * t * t; }
...
double easeInOutElastic(double t) {
  ...
  if (t < 0.5)
    return -(pow(2.0, 20.0 * t - 10.0) *
             sin((20.0 * t - 11.125) * (2 * std::numbers::pi) / 4.5)) /
           2.0;
