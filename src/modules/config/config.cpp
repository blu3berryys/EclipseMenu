...
static std::unordered_map<std::string_view, std::vector<std::function<void()>>>
    callbacks;

nlohmann::json& getStorage() { return storage; }

nlohmann::json& getTempStorage() { return tempStorage; }
