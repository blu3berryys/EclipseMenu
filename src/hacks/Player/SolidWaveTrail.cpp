...
class $modify(SolidWaveTrailCCDNHook, cocos2d::CCDrawNode){
    ALL_DELEGATES_AND_SAFE_PRIO("player.solidwavetrail")
        ...
        bool drawPolygon(cocos2d::CCPoint * p0, unsigned int p1,
                         const cocos2d::ccColor4F &p2, float p3,
                         const cocos2d::ccColor4F &p4){
            if (p2.r == 1.F && p2.g == 1.F && p2.b == 1.F &&
                p2.a != 1.F) return true;
