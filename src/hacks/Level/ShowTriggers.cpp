...
class ShowTriggers : public hack::Hack {
  ...
  [[nodiscard]] bool isCheating() override {
    return config::get<bool>("level.showtriggers", false);
  }
...
constexpr std::array<int, 131> triggerIds = {
    ...
    1811, 1812, 1814, 1815, 1817, 1818, 1819, 1912, 1913, 1914, 1915, 1916,
    ...
    3617, 3618, 3619, 3620, 3640, 3641, 3642, 3655, 3660, 3661, 3662, 3643,
    3006, 3007, 3008, 3009, 3010, 3011, 3012, 3013, 3014, 3015, 2903};

class $modify(GameObject){
    ADD_HOOKS_DELEGATE("level.showtriggers")

        void customSetup() override{bool editorEnabled = this->m_editorEnabled;
int id = this->m_objectID;
this->m_editorEnabled =
    editorEnabled ||
    std::ranges::any_of(triggerIds, [id](int id2) { return id == id2; });
...
class $modify(PlayLayer){
    void addObject(GameObject * obj){if (!obj) return PlayLayer::addObject(obj);

/*
 * // original code
 * if (m_objectID == 3613 || m_objectID == 3662
 *  || obj->getType(obj) == Modifier && (obj->m_unk4D0 != 1 ||
 * !obj->m_isTouchTriggered) && obj->m_objectID != 2063) {
...
class $modify(GJBaseGameLayer){
    // this function appears just after that if statement in
    // PlayLayer::addObject
