...
void LabelsContainer::recalculateLayout() { this->updateLayout(false); }

void LabelsContainer::addLabel(
    SmartLabel *label, const std::function<void(SmartLabel *)> &update) {
...
void LabelsContainer::removeLabel(SmartLabel *label) {
  auto it = std::ranges::find_if(
      m_labels, [label](const auto &pair) { return pair.first == label; });
