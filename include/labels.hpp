...
/// @brief Concept for supported types in the label system (bool, int64_t,
/// double, std::string, RiftNull)
template <typename T>
concept SupportedType = requires(T a) {
  std::same_as<T, bool> || std::same_as<T, int64_t> ||
...
/// @brief Formats a string using the RIFT syntax and variables provided by
/// Eclipse.
